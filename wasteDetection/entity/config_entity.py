...
class DataIngestionConfig:
    # artifacts/data_ingestion -> to store zipped dataset
    data_ingestion_dir: str = os.path.join(
        training_pipeline_config.artifacts_dir, DATA_INGESTION_DIR_NAME
    )

    # artifacts/feature_store -> to store unzipped dataset
...
class DataValidationConfig:
    ...
    valid_status_file_dir: str = os.path.join(data_validation_dir, DATA_VALIDATIOM_STATUS_FILE)
